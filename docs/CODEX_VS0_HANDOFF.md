# CODEX — VS0 HANDOFF
    ...
    TASK STATUS: ACCEPTED — VS0-T01, VS0-T01R, VS0-T02, VS0-T03. Spec §39 is the
                 ...
                 T04's write scope is FOUR paths: /addons/gut/** /tools/test/**
                 /docs/ENGINE.md and /icon.svg.import — the last is GENERATED by the
                 pinned engine's import run, never authored. Expected task shape:
                 263 A / 1 M / 0 D / 0 R / 0 C. Any OTHER versioned path produced by
                 --import is a STOP (§42.6).
